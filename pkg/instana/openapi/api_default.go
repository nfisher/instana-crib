 ...
 * @param id
*/
func (a *DefaultApiService) Delete(ctx _context.Context, id string) (*_nethttp.Response, error) {
	var (
...
func (a *DefaultApiService) DeleteSourceMapConfig(ctx _context.Context, websiteId string, sourceMapConfigId string) (*_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"sourceMapConfigId"+"}", _neturl.QueryEscape(parameterToString(sourceMapConfigId, "")), -1)
 ...
 * @param id
*/
func (a *DefaultApiService) Disable(ctx _context.Context, id string) (*_nethttp.Response, error) {
	var (
 ...
 * @param id
*/
func (a *DefaultApiService) Enable(ctx _context.Context, id string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
